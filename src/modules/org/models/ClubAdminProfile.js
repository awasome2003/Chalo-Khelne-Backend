...
const ClubAdminProfileSchema = new mongoose.Schema(
  {
    ...
    // Organisation type. "school" and "organization" admins unlock the extra
    // Coach / Trainer staff roles in staff management; "club" gets Manager only.
    orgType: {
      type: String,
      enum: ["club", "school", "organization"],
      default: "club",
    },
    registrationDate: {
      type: Date,
